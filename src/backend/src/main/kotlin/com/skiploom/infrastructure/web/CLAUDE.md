...
- **AdminController.kt**: Server-rendered admin pages (`GET /admin/`, `GET /admin/account-disabled`); uses `@Controller` with Thymeleaf views, separate from REST API controllers
